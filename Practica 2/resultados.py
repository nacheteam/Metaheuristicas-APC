...
for k in [1,3,5]:
    ...
    for fichero in FICHEROS_DATOS:
        ...
        resultados = [res_1nn, res_relief, res_bl, res_genetico_estacionario_blx, res_genetico_estacionario_aritmetico, res_genetico_generacional_blx, res_genetico_generacional_aritmetico, res_memetico_1_blx, res_memetico_01_blx, res_memetico_01_mejores_blx, res_memetico_1_aritmetico, res_memetico_01_aritmetico, res_memetico_01_mejores_aritmetico]
        print("\n\n\n")
        print("############################################")
